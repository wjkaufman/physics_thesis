...
CORY-48 designed to decouple all interactions while being robust to rotation and offset errors
...
Goal: decouple all interactions (\(\overline{H}=0\)) in strongly coupled spin system with experimental imperfections.
...
\begin{itemize}
    \item Unconstrained search (\emph{tabula rasa}, no AHT knowledge), 1\% pulse rotation error, no phase transients error, different pulse sequence lengths ($12\tau, 24\tau, 36\tau, 48\tau$)
    \item AHT-constrained search, 1\% pulse rotation error, no phase transients error, $48\tau$ sequence length
    \item AHT-constrained search, 5\% pulse rotation error, .1\% phase transients error, $48\tau$ sequence length
\end{itemize}
...
% TODO add robust pulse sequence too!
\begin{figure}
\centering
...
\begin{frame}
{Robustness to pulse rotation error}

% TODO include az12, az48 (w AHT), and robust, plus yxx48 and c48
\begin{figure}
\centering
\includegraphics[width=.9\textwidth]{rot_errors.pdf}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=.9\textwidth]{phase_transients.pdf}
\end{figure}
...
% % TODO replace with new data if/when I get it
%
% \begin{figure}
% \centering
% \includegraphics[width=.9\textwidth]{rot_errors-AHT.pdf}
% \end{figure}
%
% \end{frame}
%
...
% \begin{figure}
% \centering
% \includegraphics[width=.9\textwidth]{phase_transients-AHT.pdf}
% \end{figure}
%
% \end{frame}
%
...
% \begin{figure}
% \centering
% \includegraphics[width=.9\textwidth]{rot_errors-robust.pdf}
% \end{figure}
%
% \end{frame}
%
...
% \begin{figure}
% \centering
% \includegraphics[width=.9\textwidth]{phase_transients-robust.pdf}
% \end{figure}
%
% \end{frame}
