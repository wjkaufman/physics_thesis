...
\titlegraphic{
\includegraphics[height=.08\textheight]{Dartmouth.pdf}
\hfill
\includegraphics[height=.08\textheight]{mit_logo.png}
}
...
\begin{figure}
\centering
\includegraphics[width=.5\textwidth]{decay_plot.pdf}
...
\begin{figure}
\centering
\includegraphics[width=0.5\textwidth]{AHT-HO-diagram.pdf}
...
\begin{figure}
\centering
\includegraphics[width=.6\textwidth]{rl.png}
...
% TODO put one plot on each slide, all pulse sequences in the plot
% TODO break it into different pulse sequence lengths
% TODO then robustness pulse sequences
...
\begin{figure}
\centering
\includegraphics[width=.75\textwidth]{pulse-sequence-length.pdf}
\end{figure}
% TODO make sure yxx48 and cory48 are in this too

% todo and add robustness plots for rotation and phase transient errors
...
% TODO make robustness plots once I have further data...
