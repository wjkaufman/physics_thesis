...
\begin{equation}\label{eq:rewards}
    r = -\log\left( 1- \text{fidelity}(U_\text{target}, U_\text{exp})%^{\tau/t}
    \right)
\end{equation}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{.49\textwidth}
        ...
        \begin{tikzpicture}[->, thick]
         %nodes
         \node[draw] at (-2.5,4) (sinput) {State input ($32\times5$)};
         \node[draw] at (-2.5,3) (lstm) {LSTM layer (64 hidden units)};
         \node[draw] at (-2.5,2) (d1a) {Dense layer (64, elu)};
         \node[draw] at (2.5,3) (ainput) {Action input ($1\times 5$)};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{2020-07-07/reward_hist_2.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{2020-07-07/reward_hist_3.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\linewidth]{2020-07-07/reward_hist_4.pdf}
