...
\draw  (114.5,118) -- (533.23,118)(114.5,18) -- (114.5,118) -- cycle (526.23,113) -- (533.23,118) -- (526.23,123) (109.5,25) -- (114.5,18) -- (119.5,25)  ;
%Shape: Axis 2D [id:dp9164432492680309]
\draw  (115.27,235) -- (534,235)(115.27,135) -- (115.27,235) -- cycle (527,230) -- (534,235) -- (527,240) (110.27,142) -- (115.27,135) -- (120.27,142)  ;
...
\draw   (246,332) .. controls (246,336.67) and (248.33,339) .. (253,339) -- (292.5,339) .. controls (299.17,339) and (302.5,341.33) .. (302.5,346) .. controls (302.5,341.33) and (305.83,339) .. (312.5,339)(309.5,339) -- (352,339) .. controls (356.67,339) and (359,336.67) .. (359,332) ;
...
\draw   (286,283.75) .. controls (286,288.42) and (288.33,290.75) .. (293,290.75) -- (313,290.75) .. controls (319.67,290.75) and (323,293.08) .. (323,297.75) .. controls (323,293.08) and (326.33,290.75) .. (333,290.75)(330,290.75) -- (353,290.75) .. controls (357.67,290.75) and (360,288.42) .. (360,283.75) ;
%Shape: Brace [id:dp5227638799674247]
\draw   (361,332) .. controls (361,336.67) and (363.33,339) .. (368,339) -- (386.5,339) .. controls (393.17,339) and (396.5,341.33) .. (396.5,346) .. controls (396.5,341.33) and (399.83,339) .. (406.5,339)(403.5,339) -- (425,339) .. controls (429.67,339) and (432,336.67) .. (432,332) ;
%Shape: Brace [id:dp9824992892791732]
\draw   (361,283.75) .. controls (361,288.42) and (363.33,290.75) .. (368,290.75) -- (386.75,290.75) .. controls (393.42,290.75) and (396.75,293.08) .. (396.75,297.75) .. controls (396.75,293.08) and (400.08,290.75) .. (406.75,290.75)(403.75,290.75) -- (425.5,290.75) .. controls (430.17,290.75) and (432.5,288.42) .. (432.5,283.75) ;
%Shape: Brace [id:dp8842086542819302]
\draw   (363,239.5) .. controls (363,244.17) and (365.33,246.5) .. (370,246.5) -- (388.75,246.5) .. controls (395.42,246.5) and (398.75,248.83) .. (398.75,253.5) .. controls (398.75,248.83) and (402.08,246.5) .. (408.75,246.5)(405.75,246.5) -- (427.5,246.5) .. controls (432.17,246.5) and (434.5,244.17) .. (434.5,239.5) ;
...
% Text Node
\draw (537,108.4) node [anchor=north west][inner sep=0.75pt]    {$t$};
% Text Node
\draw (538,226.9) node [anchor=north west][inner sep=0.75pt]    {$t$};
% Text Node
\draw (389.5,353.9) node [anchor=north west][inner sep=0.75pt]    {$D$};
% Text Node
\draw (389.5,299.65) node [anchor=north west][inner sep=0.75pt]    {$U_{\tau }$};
% Text Node
\draw (394.5,254.65) node [anchor=north west][inner sep=0.75pt]    {$\tau $};
